 ...
 * Includes utility functions for creating and managing icons.
 */
...
/**
 * Creates a reusable icon component from an SVG path.
 * @param {string} path - SVG path data
 * @param {string} [viewBox="0 0 24 24"] - SVG viewBox dimensions
 * @param {Partial<IconProps>} [additionalProps] - Additional props to apply to the icon
 * @returns {React.FC<IconProps>} Icon component
 */
const createIcon = (
  path: string,
...
/**
 * Discord social media icon.
 * @param {IconProps} props - Icon properties
 * @returns {JSX.Element} Discord SVG
 */
 ...
 * @param {IconProps} props - Icon properties
 * @returns {JSX.Element} Twitter SVG
 */
 ...
 * @param {IconProps} props - Icon properties
 * @returns {JSX.Element} GitHub SVG
 */
...
/**
 * X (close) icon for closing menus and dialogs.
 * @param {IconProps} props - Icon properties
 * @returns {JSX.Element} X SVG
 */
